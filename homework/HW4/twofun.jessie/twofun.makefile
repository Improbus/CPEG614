...
USERWHYTWOOPT=
USERWHYTHREEOPT=
WHY=WHYLIB=$(WHYLIB) $(WHYEXEC) $(WHYOPT) $(USERWHYTWOOPT) -explain -locs twofun.loc

GWHY=WHYLIB=$(WHYLIB) $(GWHYEXEC) $(WHYOPT) $(USERWHYTWOOPT) -explain -locs twofun.loc
...
all: simplify/twofun_why.sx

project: why/twofun.wpr

why/%.wpr:  WHYOPT=--project -dir why
why/%.wpr: why/%.why
	@echo 'why --project [...] why/$*.why' && $(WHY) $(JESSIELIBFILES) why/$*.why

goals: why/twofun_ctx.why

why/%_ctx.why: WHYOPT=--multi-why -dir why
why/%_ctx.why: why/%.why
	@echo 'why --multi-why [...] why/$*.why' && $(WHY) $(JESSIELIBFILES) why/$*.why

coq: coq/twofun_why.vo

coq/twofun_why.v: WHYOPT=-coq -dir coq -coq-preamble "Require Export jessie_why." -coq-tactic "intuition"
coq/twofun_why.v: why/twofun.why
	@echo 'why -coq [...] why/twofun.why' && $(WHY) $(JESSIELIBFILES) why/twofun.why && rm -f coq/jessie_why.v

coq-goals: goals coq/twofun_ctx_why.vo
	for f in why/*_po*.why; do make -f twofun.makefile coq/`basename $$f .why`_why.v ; done

coq/twofun_ctx_why.v: WHYOPT=-no-pervasives -coq -dir coq -coq-preamble "Require Export jessie_why." -coq-tactic "intuition"
coq/twofun_ctx_why.v: why/twofun_ctx.why
	@echo 'why -coq [...] why/twofun_ctx.why' && $(WHY) why/twofun_ctx.why

coq/%_why.v: WHYOPT=-no-pervasives -coq -dir coq -coq-preamble "Require Export twofun_ctx_why." -coq-tactic "intuition"
coq/%_why.v: why/%.why
	@echo 'why -coq [...] why/$*.why' && $(WHY) why/twofun_ctx.why why/$*.why

coq/%.vo: coq/%.v
	coqc -I coq $<
coq/%_po_why.vo: coq/twofun_ctx_why.vo

pvs: pvs/twofun_why.pvs
...
isabelle: isabelle/twofun_why.thy
...
simplify: simplify/twofun_why.sx
...
alt-ergo ergo: why/twofun_why.why
...
why3replay: twofun.mlw
	 why3replayer $(USERWHYTHREEOPT) --extra-config $(JESSIE3CONF) $<

-include twofun.depend

depend: coq/twofun_why.v
	-$(COQDEP) -I coq coq/twofun*_why.v > twofun.depend
