...
USERWHYTWOOPT=
USERWHYTHREEOPT=
WHY=WHYLIB=$(WHYLIB) $(WHYEXEC) $(WHYOPT) $(USERWHYTWOOPT) -explain -locs series.loc

GWHY=WHYLIB=$(WHYLIB) $(GWHYEXEC) $(WHYOPT) $(USERWHYTWOOPT) -explain -locs series.loc
...
all: simplify/series_why.sx

project: why/series.wpr

why/%.wpr:  WHYOPT=--project -dir why
why/%.wpr: why/%.why
	@echo 'why --project [...] why/$*.why' && $(WHY) $(JESSIELIBFILES) why/$*.why

goals: why/series_ctx.why

why/%_ctx.why: WHYOPT=--multi-why -dir why
why/%_ctx.why: why/%.why
	@echo 'why --multi-why [...] why/$*.why' && $(WHY) $(JESSIELIBFILES) why/$*.why

coq: coq/series_why.vo

coq/series_why.v: WHYOPT=-coq -dir coq -coq-preamble "Require Export jessie_why." -coq-tactic "intuition"
coq/series_why.v: why/series.why
	@echo 'why -coq [...] why/series.why' && $(WHY) $(JESSIELIBFILES) why/series.why && rm -f coq/jessie_why.v

coq-goals: goals coq/series_ctx_why.vo
	for f in why/*_po*.why; do make -f series.makefile coq/`basename $$f .why`_why.v ; done

coq/series_ctx_why.v: WHYOPT=-no-pervasives -coq -dir coq -coq-preamble "Require Export jessie_why." -coq-tactic "intuition"
coq/series_ctx_why.v: why/series_ctx.why
	@echo 'why -coq [...] why/series_ctx.why' && $(WHY) why/series_ctx.why

coq/%_why.v: WHYOPT=-no-pervasives -coq -dir coq -coq-preamble "Require Export series_ctx_why." -coq-tactic "intuition"
coq/%_why.v: why/%.why
	@echo 'why -coq [...] why/$*.why' && $(WHY) why/series_ctx.why why/$*.why

coq/%.vo: coq/%.v
	coqc -I coq $<
coq/%_po_why.vo: coq/series_ctx_why.vo

pvs: pvs/series_why.pvs
...
isabelle: isabelle/series_why.thy
...
simplify: simplify/series_why.sx
...
alt-ergo ergo: why/series_why.why
...
why3replay: series.mlw
	 why3replayer $(USERWHYTHREEOPT) --extra-config $(JESSIE3CONF) $<

-include series.depend

depend: coq/series_why.v
	-$(COQDEP) -I coq coq/series*_why.v > series.depend
