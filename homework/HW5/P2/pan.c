...
short src_ln0 [] = {
	  0,  23,  24,  25,  26,  23,  27,  31, 
	 17,  17,  17,  16,  34,  28,  17,  17, 
	 17,  16,  39,  37,  42,  13,  12,  46, 
	 44,  13,  12,  51,  49,  54,  58,  59, 
	 60,  61,  62,  63,  64,  65,  60,  66, 
	 66,  58,  68,  68,  69,  70,  71,  72, 
	 73,  74,  75,  70,  76,  76,  68,  77, 
	 56,  27,  80,  27,  80,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "dictionary.pml", 1, 60 },
...
iniglobals(int calling_pid)
{
	...
	{	int l_in;
		for (l_in = 0; l_in < 4; l_in++)
		{
			logval("dictionary[l_in]", now.dictionary[l_in]);
		}
	}
#endif
}
...
{	/* int i; */
	...
	{	int l_in;
		for (l_in = 0; l_in < 4; l_in++)
		{
			printf("	bit    dictionary[%d]:	%d\n", l_in, now.dictionary[l_in]);
		}
	}
}
void
