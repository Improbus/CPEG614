...
#define nstates2	33	/* fair */
#define minseq2	53
#define maxseq2	84
#define endstate2	32

#define nstates1	11	/* mutex */
#define minseq1	43
#define maxseq1	52
#define endstate1	10

#define nstates0	44	/* bakery */
#define minseq0	0
#define maxseq0	42
#define endstate0	43
...
#define Pbakery	((P0 *)this)
typedef struct P0 { /* bakery */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, _1_1_i) - 1*sizeof(int))
